                     ...
                     void *args)
{
    ...
    encode_cose_evidence(context, cose_args->ubc_cbor_evidence,
                 cose_args->serialized_black_key,
                 cose_args->serialized_black_key_len);
}
                      ...
                      size_t serialized_black_key_len)
{
	struct cose_evidence_args args = {
        ...
        .serialized_black_key = serialized_black_key,
        .serialized_black_key_len = serialized_black_key_len,
	};
