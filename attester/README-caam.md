...
scp out/imx/optee_remote_attestation root@<device-ip>:/usr/bin/

# On device
optee_remote_attestation --provision  # Generate CAAM keys
optee_remote_attestation              # Run attestation
```
