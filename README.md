...
For i.MX 8M Plus Yocto builds, see `attester/container-imx/README.md`. For QEMU-only Attester steps, see `attester/README.md`. For real hardware attestation on i.MX8MP EVK, see [step 8](#8-imx8mp-real-hardware-attestation) below.
...
i.MX 8M Plus 向け Yocto ビルドの手順は `attester/container-imx/README.md` を参照してください。QEMU 向けの Attester 手順のみ確認したい場合は `attester/README.md` を参照してください。i.MX8MP EVK 実機でのアテステーションは[手順 8](#8-imx8mp-実機でのアテステーション) を参照してください。
